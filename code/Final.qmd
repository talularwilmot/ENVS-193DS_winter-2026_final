...
## h. Write a caption 
**Figure 1. Binomial regression of suitable habitat based on obstruction** Blue points represent raw data points of used or unused habitat for Mountain Plovers. Line represents predicted equation for suitable habitat while orange lines outline the 95% confidence interval for those estimates. Data was collected by Duchardt, Courtney; Beck, Jeffrey; Augustine, David (2020). Data from: Mountain Plover habitat selection and nest survival in relation to weather variability and spatial attributes of Black-tailed Prairie Dog disturbance [Dataset]. Dryad. https://doi.org/10.5061/dryad.ttdz08kt7 and accessed via csv download. 
...
Mountain plovers tend to chose nest sights with no visual obstruction because they have a better peripheral view of potential predators. Prairie dog occupancy often creates lack of obstruction from soil disturbance and consumption of nearby shrubs but there was not 
